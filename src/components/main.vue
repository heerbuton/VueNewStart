  ...
  <div class="container">
    ...
    <nav class="navbar">
      ...
      <div class="nav-links">
        ...
        <a href="#"><i class="fas fa-comment"></i> 评价中心</a>
        <a href="#"><i class="fas fa-comments"></i> 聊天中心</a>
    ...
    <!-- 内容区域 -->
    <div class="content">
      <div class="empty-message">AI图件1</div>
      <button class="details-btn" @click="login">详情</button>
    </div>
